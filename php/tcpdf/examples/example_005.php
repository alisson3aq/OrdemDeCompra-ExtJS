...
$pdf->MultiCell(30, 0, 'Data Pedido', 1, 'C', 0, 0, '', '', true);
$pdf->MultiCell(147, 0, 'Dados do Fornecedor', 0, 'C', 0, 1, '', '', true);
$pdf->SetFont('times', '', 12);
$pdf->setCellPaddings(1, 1, 1, 1);
$pdf->MultiCell(30, 5, '11/12/2014', 1, 'C', 0, 0, '', '', true);
$pdf->MultiCell(110, 5, 'SUL AR ÁGUA EQUIPAMENTOS LTDA',1, 'L', 0, 0, '' ,'', true);
$pdf->setCellPaddings(1, 1, 1, 2);
$pdf->SetFont('times', '', 10);
$pdf->MultiCell(35, 5, '80.706.492/0001-73',1, 'C', 0, 3, '' ,'', true);
$pdf->setCellPaddings(0, 0, 0, 0);
$pdf->setCellMargins(1, 0, 1, 0);
$pdf->MultiCell(30, 5, 'Processo', 1, 'C', 0, 0, '', '', true);
$pdf->MultiCell(30, 5, 'Endereco', 1, 'C', 0, 1, '', '', true);
$pdf->setCellPaddings(1, 1, 1, 2);
$pdf->SetFont('times', '', 10);
$pdf->MultiCell(35, 5, '80.706.492/0001-73',1, 'C', 0, 3, '' ,'', true);
